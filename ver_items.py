...
def visualizar_por_propriedade(dados_totais):
...
def visualizar_item():
    ...
    with open('dados.txt', 'r') as dados:
        ...
        if escolha == '1':
            visualizar_por_nome(dados_totais = dados_totais)
                    
                        
        #  2.3.2. busca por propriedade do item
        elif escolha == '2':
            visualizar_por_propriedade(dados_totais = dados_totais)